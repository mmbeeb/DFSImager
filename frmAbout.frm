...
Begin VB.Form frmAbout 
   ...
   Begin VB.Label Label4 
      Alignment       =   2  'Center
      Caption         =   " Acorn DFS Single and Double Sided Disk Image manipulation, including file dragging to and from Windows Explorer."
      Height          =   615
      Left            =   720
      TabIndex        =   3
      Top             =   1680
...
Private Sub Form_Load()
    LabelVer.Caption = "DFS Imager Version " & ProgVersion
End Sub
